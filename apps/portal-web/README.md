...
The landlord Properties workspace includes a frontend-only v1.0 property setup
prototype. It validates Property and first-Unit input with
`@keyforta/contracts` and stores synthetic drafts under
`keyforta.portal.property-drafts` in browser local storage. It does not call the
API, establish organization authority, or create production inventory.
