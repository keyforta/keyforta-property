...
| --------------- | ------------------------------------------------- | -------------------------------------------------------------------------------- | ------------------------------------------------------------------------------ |
| Public website  | Visitor or prospective tenant                     | Discover published rentals, request a visit, submit a rental application, and reach sign-in | Submission does not reserve the unit; automatic (non-human) application acceptance or reservation is not permitted — every application requires an explicit human review decision before acceptance (see PRD amendment, issue #75) |
