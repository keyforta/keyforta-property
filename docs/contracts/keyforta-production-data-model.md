...
| Property     | Property, Unit, Asset, Meter, Media (Portfolio is a derived Reporting scope, not a persisted entity — see `keyforta-context-map-and-ownership.md` §Property & Inventory, pending issue #85 ratification) |
